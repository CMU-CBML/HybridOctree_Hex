...
#ifndef VOXEL_SIZE_VALUE
#define VOXEL_SIZE_VALUE 9
#endif
const int VOXEL_SIZE = VOXEL_SIZE_VALUE;// log2 voxel size
// Octree level of the deepest refinement tier — see ComputeCellValue().
// 8 is v1.0's own hardcoded value; "(octreeDepth - 1)" makes the whole tier
// ladder ride on VOXEL_SIZE.
#ifndef LADDER_TOP
#define LADDER_TOP 8
#endif
// C_THRES is overridable at compile time (-DC_THRES_VALUES="{...}") so one
// source tree can serve several calibration builds; the default below is
// v1.0's own shipped value, byte-for-byte.
...
#endif
const double H_THRES[5] = H_THRES_VALUES;// 4 5 6 7 8
...
#ifndef OUT_IN_RATIO_VALUE
#define OUT_IN_RATIO_VALUE 0.125
#endif
const double OUT_IN_RATIO = OUT_IN_RATIO_VALUE;
...
#ifndef CELL_DETECT_VALUE
#define CELL_DETECT_VALUE 1
#endif
const double CELL_DETECT = CELL_DETECT_VALUE;
